// India States, Districts, and Cities/Villages Data
// Comprehensive location data for registration
...
const indiaLocations = {
    ...
    cities: {
        "Chennai": ["Chennai", "Tambaram", "Avadi", "Ambattur", "Porur", "Velachery", "Adyar", "T. Nagar"],
        "Coimbatore": ["Coimbatore", "Pollachi", "Mettupalayam", "Sulur"],
        "Madurai": ["Madurai", "Thirumangalam", "Melur", "Peraiyur"],
        "Bengaluru Urban": ["Bangalore", "Yelahanka", "Whitefield", "Electronic City", "Jayanagar", "Koramangala"],
        "Hyderabad": ["Hyderabad", "Secunderabad", "Kukatpally", "Madhapur", "Gachibowli"],
        "Mumbai City": ["Mumbai", "Colaba", "Fort", "Churchgate"],
